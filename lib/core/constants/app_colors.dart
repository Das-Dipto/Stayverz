...
class AppColors {
  static const Color primaryColor = Color(0xFFF15925);
  static const Color primaryBlack = Color(0xff1f1f1f);
  static const Color badgeColor = Color(0xff4cae1b);
  static const Color primaryColorDarkVariaent = Color(0xff507367);
  static const Color primaryBlueBg = Color(0xff0961f5);
  static const Color scaffoldLightestBg = Color(0xffF5FAF8);
