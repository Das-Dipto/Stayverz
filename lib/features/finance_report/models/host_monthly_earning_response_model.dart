...
class HostMonthlyEarningResponseModel {
  final bool? success;
  final int? statusCode;
  final String? message;
  final MonthlyEarningData? data;

  HostMonthlyEarningResponseModel({
    this.success,
    this.statusCode,
    this.message,
    this.data,
  ...
  factory HostMonthlyEarningResponseModel.fromRawJson(String str) => HostMonthlyEarningResponseModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory HostMonthlyEarningResponseModel.fromJson(Map<String, dynamic> json) => HostMonthlyEarningResponseModel(
    success: json["success"],
    statusCode: json["status_code"],
    message: json["message"],
    data: json["data"] == null ? null : MonthlyEarningData.fromJson(json["data"]),
  );
...
class MonthlyEarningData {
  ...
  factory MonthlyEarningData.fromRawJson(String str) => MonthlyEarningData.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory MonthlyEarningData.fromJson(Map<String, dynamic> json) => MonthlyEarningData(
