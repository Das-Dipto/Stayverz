...
class StepNinthCreateListingBody extends StatefulWidget {
  const StepNinthCreateListingBody({super.key});

  @override
  State<StepNinthCreateListingBody> createState() =>
      _StepNinthCreateListingBodyState();
}

class _StepNinthCreateListingBodyState
    extends State<StepNinthCreateListingBody> {
  ...
  void _initQuillIfNeeded() {
    ...
    final existingText = _listingController.descriptionController.text.trim();
    ...
    _quillController!.addListener(() {
      ...
      _listingController.descriptionController.text = plain;
    });
  }
