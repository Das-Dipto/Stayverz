...
class StepSecondCreateListingBody extends GetView<ListingController> {
  StepSecondCreateListingBody({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const Gap(30),
        Obx(() {
            final List<Category> firstStepContents = controller.listingConfiguration.value?.categories ?? [];
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              buildImage(firstStepContents[index].iconMobile),
                              const Gap(8)
                            ],
                          ),
                        ),
