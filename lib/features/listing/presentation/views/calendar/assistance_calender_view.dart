...
import 'package:stayverz_flutter_app/features/assistance_service/repositories/assistance_service_repository_interface.dart';
import '../../../controllers/assistance_calender_controller.dart';
...
class AssistanceCalenderView extends StatefulWidget {
  final String title;
  final String id;
  final String? image;
  const AssistanceCalenderView({
    super.key,
    required this.title,
    required this.id,
    this.image,
  ...
  @override
  State<AssistanceCalenderView> createState() => _AssistanceCalenderViewState();
}

class _AssistanceCalenderViewState extends State<AssistanceCalenderView> {
  final controller = AssistanceServiceController(Get.find<AssistanceServiceRepositoryInterface>());
  final ReservationController controllerReserve = Get.find<ReservationController>();
  final AssistanceCalendarController calenderController = Get.put(AssistanceCalendarController());
        ...
        child: Column(
          children: [
            ...
            Obx(() {
              ...
              final calendar = controller.assistanceCalendarResponse.value;
              if (calendar == null) {
                return const Text('No calendar data');
              }

              calenderController.calendarResponse.value = controller.assistanceCalendarResponse.value;
                          ...
                          GestureDetector(
                            ...
                            child: GridView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Obx(() {
                                  final isSelected = calenderController.selectedDates.any((d) => calenderController.isSameDate(d, date));
                                  ...
                                  final bookingData = calenderController
                                      .calendarResponse
                                      .value!
                                      .data
                                      ?.calendarData?[
                                  ...
                                  final reserveId = bookingData != null && bookingData.isNotEmpty
                                      ? bookingData.first.booking?.invoiceNo
                                      : null;
                                  // If booked, only show avatar
                                  Widget cellContent;

                                  if (bookingData != null && bookingData!.isNotEmpty&& reserveId!=null) {
                                    final firstUser = bookingData!.first.user;
                                    final extraCount = bookingData!.length - 1;

                                    cellContent = GestureDetector(
                                      onTap: () async {
                                        _showBookingBottomSheet(context, bookingData);
                                      },
                                      child: Stack(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Image.network(
                                              firstUser?.image ?? "",
                                              fit: BoxFit.cover,
                                              errorBuilder: (a, b, c) => const Icon(Icons.person, color: Colors.white54),
                                            ),
                                          ),
                                          if (extraCount > 0)
                                            Container(
                ...
                onTap: () {
                  if (calenderController.selectedDates.isEmpty) {
                    ...
                    if (selectedDates.isNotEmpty) {
                      ...
                      final dayData = calenderController.calendarResponse.value?.data?.calendarData?[firstDateKey];
                    ...
                    AwesomeDialog(
                      ...
                      body: Obx(() {
                        ...
                        final guestFee = controller.assistanceCalendarResponse.value!.data?.listing?.guestServiceCharge ?? 0.0;
                        final hostFee = controller.assistanceCalendarResponse.value!.data?.listing?.hostServiceCharge ?? 0.0;
  ...
  void _showBookingBottomSheet(
      BuildContext context, List<BookingDataItem> bookingData) {
          ...
          child: Column(
            ...
            children: [
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final user = bookingData[index]?.user;
                  return InkWell(
                    onTap: (){
                      ...
                      controllerReserve.fetchAssistanceReservationById(id: "${bookingData[index].booking?.invoiceNo}");
                      showModalBottomSheet(
                        context: context,
                        isScrollControlled: true,
                                ...
                                Padding(
                                  ...
                                  child: SingleChildScrollView(
                                    child: Container(
                                      ...
                                      child: Obx(() {
                                        if (controllerReserve.isAssistanceReservationLoading.value) {
                                          return Padding(
                                            padding: const EdgeInsets.only(top: 150),
                                            child: Center(child: CircularProgressIndicator()),
                                          );
                                        }
                                        if (controllerReserve.reservationAssistanceHasError.value) {
                                          return Center(
                                            child: Text(
                                              controllerReserve.reservationAssistanceErrorMessage.value,
                                              style: const TextStyle(color: Colors.red),
                                            ),
                                          );
                                        }
                                        final reservation = controllerReserve.selectedAssistanceReservation.value;
                                        if (reservation == null) {
                                        ...
                                        return Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Image.network(
                                                      "${controllerReserve.selectedAssistanceReservation.value?.guestInfo?.image}",
                                                      height: 50,
                                                      width: 50,
                                                      fit: BoxFit.cover,
                                                  ...
                                                  const Gap(10),
                                                  Text(
                                                    "${controllerReserve.selectedAssistanceReservation.value!.guestInfo?.firstName}",
                                                    style: const TextStyle(
                                                      color: Colors.black,
                                                      fontSize: 16,
                                                      fontFamily: 'Inter',
                                              ...
                                              Text(
                                                '${controllerReserve.selectedAssistanceReservation.value?.listing?.title}',
                                                style: const TextStyle(
                                              ...
                                              const Gap(8),
                                              Text(
                                                '${formatDate("${controllerReserve.selectedAssistanceReservation.value!.checkIn}")}'
                                                    ' - '
                                                    '${formatDate("${controllerReserve.selectedAssistanceReservation.value!.checkOut}")}'
                                                    ' (${controllerReserve.selectedAssistanceReservation.value?.nightCount ?? 0} Night)',                                                style: const TextStyle(
                                                  color: Color(0xFF67666B),
                                                  fontSize: 16,
                                                  fontFamily: 'Inter',
                                                  fontWeight: FontWeight.w500,
                                              ...
                                              const Gap(8),
                                              Text(
                                                '${controllerReserve.selectedAssistanceReservation.value?.guestCount} Guests',
                                                style: const TextStyle(
                                                  color: Color(0xFF67666B),
                                                  fontSize: 16,
                                                  fontFamily: 'Inter',
                                              ...
                                              const Gap(10),
                                              Text(
                                                'About ${controllerReserve.selectedAssistanceReservation.value?.guestInfo?.firstName}',
                                                style: const TextStyle(
                                                  color: Colors.black,
                                                  fontSize: 16,
                                                  fontFamily: 'Inter',
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      Text(
                                                        (controllerReserve.selectedAssistanceReservation.value?.guestInfo?.identityVerificationStatus ?? "")
                                                            .replaceAll('_', ' ')
                                                            .split(' ')
                                                      ...
                                                      Icon(
                                                        (() {
                                                          final status = controllerReserve.selectedAssistanceReservation.value?.guestInfo?.identityVerificationStatus ?? "";
                                              ...
                                              //     //     Text(
                                              //     //       (() {
                                              //     //         final status = controllerReserve.selectedAssistanceReservation.value?.guestInfo?.identityVerificationStatus ?? "N/A";
                                              //     //         return status.isNotEmpty ? status[0].toUpperCase() + status.substring(1).toLowerCase() : status;
                                              //     //       })(),
                                              //     //       style: TextStyle(
                                              //     //         color: controllerReserve.selectedAssistanceReservation.value?.guest.status == "active" ? Colors.green : const Color(0xFF67666B),
                                              //     //         fontSize: 16,
                                              //     //         fontFamily: 'Inter',
                                              //     //         fontWeight: FontWeight.w500,
                                              //     //         height: 1.50,
                                              ...
                                              //     //     const Gap(8),
                                              //     //     Icon(
                                              //     //       (controllerReserve.selectedAssistanceReservation.value?.guest.status ?? "").toLowerCase() == "active" ? Icons.check_circle : Icons.close,
                                              //     //       color: (controllerReserve.selectedAssistanceReservation.value?.guest.status ?? "").toLowerCase() == "active" ? Colors.green : Colors.red,
                                              //     //       size: 18,
                                              //     //     ),
                                              //     //   ],
                                              //     // ),
                                              ...
                                              Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      '${controllerReserve.selectedAssistanceReservation.value?.guestCount} guest',
                                                      style: const TextStyle(
                                                        color: Color(0xFF282C35),
                                                        fontSize: 12,
                                                        fontFamily: 'Inter',
                                        ...
                                        style: const TextStyle(
                                                    ...
                                                    Text(
                                                      formatToDate("${controllerReserve.selectedAssistanceReservation.value!.createdAt}"),
                                                      style: const TextStyle(
                                                        color: Color(0xFF282C35),
                                                        fontSize: 12,
                                                        fontFamily: 'Inter',
                                                    ...
                                                    Text(
                                                      '${controllerReserve.selectedAssistanceReservation.value?.reservationCode}',
                                                      style: const TextStyle(
                                                        color: Color(0xFF282C35),
                                                        fontSize: 12,
                                                        fontFamily: 'Inter',
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  Text(
                                                    '৳${controllerReserve.selectedAssistanceReservation.value?.priceInfo?.entries.isNotEmpty == true ? controllerReserve.selectedAssistanceReservation.value?.priceInfo?.entries.first.value.price : 0} x ${controllerReserve.selectedAssistanceReservation.value?.nightCount} nights',
                                                    style: const TextStyle(
                                                      color: Color(0xFF67666B),
                                                      fontSize: 16,
                                                      fontFamily: 'Inter',
                                                  ...
                                                  Text(
                                                    '৳${((controllerReserve.selectedAssistanceReservation.value?.priceInfo?.entries.isNotEmpty == true ? controllerReserve.selectedAssistanceReservation.value?.priceInfo?.entries.first.value.price : 0) ?? 0) * (controllerReserve.selectedAssistanceReservation.value?.nightCount ?? 0)}',
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    '৳${controllerReserve.selectedAssistanceReservation.value?.guestServiceCharge ?? 0}',
                                                    textAlign: TextAlign.right,
                                                    style: const TextStyle(
                                                      color: Color(0xFF67666B),
                                                      fontSize: 12,
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    '৳${controllerReserve.selectedAssistanceReservation.value?.totalPrice ?? 0}',
                                                    textAlign: TextAlign.right,
                                                    style: const TextStyle(
                                                      color: Color(0xFF424141),
                                                      fontSize: 12,
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    '৳${controllerReserve.selectedAssistanceReservation.value?.hostServiceCharge}',
                                                    textAlign: TextAlign.right,
                                                    style: const TextStyle(
                                                      color: Color(0xFF67666B),
                                                      fontSize: 16,
