...
class PublicAssistanceDetailsScreen
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...List.generate(
                                      review?.rating ?? 0,
                                      (i) => const Icon(Icons.star_sharp, size: 16),
                                    ),
                                    const Text(
                                      '. 1 week ago',
                                      textAlign: TextAlign.center,
              ...
              if (controller.publicListingDetails.value?.meetupPoint != null) ...[
                Text(
                  "I'll meet you at your location.",
                  style: TextStyle(
                    color: Colors.black,
              ...
              Column(
                ...
                children: [
                  ...
                  _buildKeyDetailRow(
                    icon: Assets.assetsGuestRequirementsIcon,
                    title: 'Guest requirements',
                    content:
                        'Service includes ${data?.maxPerson ?? 1} people. '
                        '${(data?.extraChargePerPerson ?? 0) > 0 ? '৳${data!.extraChargePerPerson} fee for every extra person.' : ''}',
                  ),
                  _buildKeyDetailRow(
                    icon: Assets.assetsGuestRequirementsIcon,
                    title: 'Cancellation Policy',
                    content: controller.publicListingDetails.value?.cancellationPolicy?.description ?? '',
                  ),
                ],
              ),
  ...
  // Helper method to prevent text overflow
...
class MeetUpLocationMapView extends GetView<PublicAssistanceServiceController> {
  ...
  late final Set<Marker> _markers = {
    Marker(markerId: const MarkerId('marker_1'), position: LatLng(lat, lng)),
  };
