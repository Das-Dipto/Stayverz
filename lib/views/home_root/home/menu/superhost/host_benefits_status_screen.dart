...
class HostBenefitsStatusScreen extends StatefulWidget {
  const HostBenefitsStatusScreen({super.key});

  @override
  State<HostBenefitsStatusScreen> createState() =>
      _HostBenefitsStatusScreenState();
}

class _HostBenefitsStatusScreenState
    extends State<HostBenefitsStatusScreen> {
  @override
