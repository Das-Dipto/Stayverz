...
import 'package:stayverz_flutter_app/views/home_root/home/menu/payment_mehtod/body/payouts_methods_body.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Obx(() {
              switch (ctrl.currentState.value) {
